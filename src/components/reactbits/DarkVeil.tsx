...
void main(){
    ...
    themeCol = mix(themeCol, colorYellow, col.g * 0.4);
    
    themeCol = hueShiftRGB(themeCol, uHueShift);
    
    float scanline_val=sin(gl_FragCoord.y*uScanFreq)*0.5+0.5;
    themeCol*=1.-(scanline_val*scanline_val)*uScan;
    themeCol+=(rand(gl_FragCoord.xy+uTime)-0.5)*uNoise;
    gl_FragColor=vec4(clamp(themeCol,0.0,1.0),1.0);
}
`;
